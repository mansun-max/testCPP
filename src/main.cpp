...
class SampleListener : public Listener {
  public:
    ...
    virtual void onHeadPose(const Controller&, int64_t);
};
...
void SampleListener::onHeadPose(const Controller& controller, int64_t timestamp) {
//  const HeadPose headPose = controller.headPose(timestamp);
//  const Vector position = headPose.position();
//  const Quaternion orientation =  headPose.orientation();
  std::cout << "Head pose:" << std::endl;
  std::cout << "  Timestamp: " << timestamp << std::endl;
//  std::cout << "  Head position (" << position.x << ", " << position.y << ", " << position.z << ")" << std::endl;
//  std::cout << "  Head orientation (" << orientation.x << ", " << orientation.y << ", " << orientation.z << ", " << orientation.w << ")" << std::endl;
}
